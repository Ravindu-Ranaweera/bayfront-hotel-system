    ...
    function sendVerificationEmail($userEmail, $token, $userName){
        ...
        <body>
            <div class="wrapper">
                ...
                <button style="background: #2EE59D; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1); border: none; border-radius: 5px; padding: 10px; "><a style="color: #fff; text-decoration: none; font-size: 20px; " href="http://localhost/hotel-login/index.php?token= ' . $token . '">Verify Account</a></button>
